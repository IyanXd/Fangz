...
➔ Nama: ${name}`
	...
	if (other) this.sendHydrated(other, `${htki} Anonymous Chats ${htka}`, tks, await conn.profilePictureUrl(m.sender, 'image').catch(_ => './src/avatar_contact.png'), `wa.me/${m.sender.split`@`[0]}`, 'Turn chat patner', null,null, [['Leave', '.leave'],[null,null],[null,null]], 0,  { mentionedJid: [m.sender]})
}
